...
object AggByKeyDemo {
  ...
  def main(args: Array[String]): Unit = {
      ...
      val rdd1 = sc.parallelize(List(("Bangalore","A"),("Bangalore","B"),("Bangalore","C"),("Bangalore","B"),("Bangalore","A"),
        ("Bangalore","D"),("Bangalore","B"),("Bangalore","E"),("Bangalore","B"),("Bangalore","A"),
        ("Mumbai","B"),("Mumbai","A"),("Mumbai","C"),("Mumbai","A"),("Mumbai","B"),("Mumbai","B"),
        ("Delhi","D"),("Delhi","B"),("Delhi","C"),("Delhi","A"),("Delhi","A")),3)

      println("List of unique values for a key:")
      val initialSet = mutable.HashSet.empty[String]
      val mergeValue = (acc : mutable.HashSet[String], v:String ) => acc += v
      val mergePartition = (p1: mutable.HashSet[String], p2:mutable.HashSet[String]) => p1 ++= p2
      ...
      rdd4.flatMap(x=>x.split(" ")).filter( x =>  filterMethod(x) ).saveAsTextFile("C:\\FILTERED_TEXT_FILE1")
