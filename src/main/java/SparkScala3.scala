...
object SparkScala3 {
  def main(args: Array[String]): Unit = {
    ...
    val wordsRDD1 = sc.parallelize(List("Good","Morning", "Hello", "World", "Hi", "Hello", "India", "Karnataka", "India"))
    ...
    val result3 = rdd7.aggregate(0,0)((acc,value) => (acc._1 + value, acc._2 + 1), (x,y) => (x._1 + y._1, x._2 + y._2))

    println("result3: " + result3)
    println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    val seqOp = (s:(Int,Int),v:Int) => if ( v % 2 == 0 ) (s._1 + v, s._2) else (s._1,s._2 + v)
    val combOp= (s1:(Int,Int),s2:(Int,Int)) => (s1._1 + s2._1, s1._2 + s2._2)
